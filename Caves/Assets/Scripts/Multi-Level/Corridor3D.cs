...
public enum TileType3D
{
    Wall, Floor, Entry1, Entry2, Entry4, Entry8, StairRoomUNDEF, DStairs1, Ustairs1, DStairs2, UStairs2, DStairs4, UStairs4, DStairs8, UStairs8,
}
...
public class Corridor3D
{
    ...
    public TileType3D FloorType;    //Type of floor tile to be placed.
    public int Depth;               //What level are we currently at.
